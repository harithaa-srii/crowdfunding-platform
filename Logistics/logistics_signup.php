<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        // Handle image upload
        if (!empty($_FILES["logistics_id_image"]["tmp_name"])) {
            $imageData = addslashes(file_get_contents($_FILES["logistics_id_image"]["tmp_name"]));
        } else {
            $imageData = null;
        }
        ...
        $sql = "INSERT INTO logistics_details (logistics_id, logistics_user_name, logistics_user_position, logistics_user_phone, logistics_user_email, logistics_user_pwd, logistics_org_name, logistics_org_place, logistics_org_phone, logistics_org_mail, logistics_id_image, childhood_pet, vacation_destination, favourite_hobby) VALUES ('$logistics_id', '$logistics_user_name', '$logistics_user_position', '$logistics_user_phone', '$logistics_user_email', '$logistics_user_pwd', '$logistics_org_name', '$logistics_org_place', '$logistics_org_phone', '$logistics_org_mail', '$imageData', '$childhood_pet', '$vacation_destination', '$favourite_hobby')";
...
@media (max-width: 700px) {
  ...
  .submit-btn .input-data{
    width: 40%!important;
        ...
        <script>
            function validateForm() {
                var password = document.getElementById("logistics_user_pwd").value;
    ...
    <body>
        ...
        <div class="container">
            <div class="form-container">
                ...
                <h2 style="text-align: center;">Logistics SignUp</h2>
                <form method="POST" action="logistics_signup.php" onsubmit="return combinedSubmit()" enctype="multipart/form-data">
    <div class="form-row">
        <div class="input-data">
            <input type="text" id="logistics_user_name" name="logistics_user_name" required>
            <div class="underline"></div>
            <label for="logistics_user_name">User Name *</label>
        </div>
        <div class="input-data">
            <input type="text" id="logistics_user_position" name="logistics_user_position" required>
            <div class="underline"></div>
    ...
    <div class="form-row">
        <div class="input-data">
            <input type="text" id="logistics_user_phone" name="logistics_user_phone" pattern="[0-9]{10}" title="Please enter exactly 10 digits."  oninput="validatePhoneNumber(this)" required>
            <div class="underline"></div>
            <label for="logistics_user_phone">User Phone *</label>
        </div>
        <div class="input-data">
            <input type="email" id="logistics_user_email" name="logistics_user_email" required>
            <div class="underline"></div>
    ...
    <div class="form-row">
        <div class="input-data">
            <input type="password" id="logistics_user_pwd" name="logistics_user_pwd" onfocus="showPasswordConditions()" oninput="checkPassword()" required>
            <div class="underline"></div>
            <label for="logistics_user_pwd">User Password *</label>
        ...
        <div class="input-data">
            <input type="text" id="logistics_org_name" name="logistics_org_name" required>
            <div class="underline"></div>
    ...
    <div class="form-row">
        <div class="input-data">
            <input type="text" id="logistics_org_place" name="logistics_org_place" required>
            <div class="underline"></div>
            <label for="logistics_org_place">Organization Place *</label>
        </div>
        <div class="input-data">
            <input type="text" id="logistics_org_phone" name="logistics_org_phone" pattern="[0-9]{10}" oninput="validatePhoneNumber(this)" required>
            <div class="underline"></div>
    ...
    <div class="form-row">
        <div class="id-image">
            <label for="logistics_id_image">Logistics ID Image *</label>  
            <input type="file" id="logistics_id_image" name="logistics_id_image" accept=".jpg, .jpeg, .png">    
        </div> 
        <div class="input-data">
            <input type="email" id="logistics_org_mail" name="logistics_org_mail" required>
        ...
        <div class="slider">
            ...
            <ul class="slides">
                            <li class="slide">
                                ...
                                <label for="childhood_pet">What was the name of your favorite childhood pet?</label>
                                <input type="text" id="childhood_pet" name="childhood_pet" required>
                                </div>
                            </li>
                            <li class="slide">
                                <div class="slide-content">
                                <h2 class="slide-title">Question #2</h2>
                                <label for="vacation_destination">What is your dream vacation destination?</label>
                                <input type="text" id="vacation_destination" name="vacation_destination" required>
                                </div>
                            </li>
                            <li class="slide">
                                <div class="slide-content">
                                ...
                                <input type="text" id="favourite_hobby" name="favourite_hobby" required>
                                </div>
                            </li>
                            </ul>
        </div>
    ...
    <div class="form-group">
        <p class="note-flash">NOTE: THE ABOVE QUESTIONS ARE FOR SECURITY PURPOSE, THEY WILL BE ASKED FOR SECURITY REASONS. KINDLY NOTE THEM DOWN.</p>
    </div>
    <div class="form-group">
        ...
        <script>
            ...
            document.addEventListener('click', function(e) {
                var passwordField = document.getElementById("logistics_user_pwd");
                var passwordConditions = document.getElementById("password-conditions");
