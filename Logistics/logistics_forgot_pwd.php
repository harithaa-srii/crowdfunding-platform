...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
    ...
    if ($new_password === $confirm_password) {
        ...
        $sql = "UPDATE logistics_details SET logistics_user_pwd='$new_password' WHERE logistics_user_email='$email' AND logistics_user_name='$username'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['username']) && isset($_POST['email'])) {
    ...
    $sql = "SELECT * FROM logistics_details WHERE logistics_user_email='$email' AND logistics_user_name='$username'";
