...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $username = $_SESSION['donor_user_name']; // Modified to retrieve username from session
    ...
    $sql = "INSERT INTO donor_posts (username, content, media) VALUES (?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: donor_landing.php"); // Redirect back to the same page
    } else {
  ...
  <div class="wrapper">
    <section class="post">
      ...
      <div class="content">
          ...
          <div class="details">
            <p><?php echo $_SESSION['donor_user_name']; ?></p>
          </div>
        </div>
