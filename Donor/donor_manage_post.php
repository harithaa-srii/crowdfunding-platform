...
<head>
    ...
    <title>Donor Post Management</title>
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
            if ($_POST['action'] == 'update' && isset($_POST['post_id'])) {
                ...
                header("Location: donor_post_update.php?post_id=" . $_POST['post_id']);
                exit();
            } elseif ($_POST['action'] == 'delete' && isset($_POST['post_id'])) {
                $postId = $_POST['post_id'];

                // Delete post from the database
                $sql = "DELETE FROM donor_posts WHERE id = $postId";
        ...
        $sql = "SELECT * FROM donor_posts ORDER BY id DESC";
