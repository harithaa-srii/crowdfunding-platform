<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO donor_queries (dch_id, dch_user_id, dch_user_name, dch_user_phone, dch_user_email, dch_desc, dch_date) VALUES (:postID, :user_id, :username, :phoneNumber,:email, :description, :date)");
