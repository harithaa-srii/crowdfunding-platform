...
if (isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['password'])) {
    ...
    $query = "SELECT * FROM donor_details WHERE donor_user_name = '$username' AND donor_user_email = '$user_email' AND donor_user_pwd = '$password'";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $_SESSION['donor_user_id'] = $row['donor_user_id'];
        $_SESSION['donor_user_name'] = $row['donor_user_name'];
        $_SESSION['donor_user_email'] = $row['donor_user_email'];
        $_SESSION['donor_user_pwd'] = $row['donor_user_pwd'];
