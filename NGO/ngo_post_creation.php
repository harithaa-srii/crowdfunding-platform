...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $username = $_SESSION['ngo_user_name'];
    ...
    $sql = "INSERT INTO ngo_posts (username, content, media, created_at) VALUES (?, ?, ?, NOW())";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ngo_landing.php"); // Redirect back to the same page
    } else {
...
body{
  ...
  min-height: 100vh;
  background:#780d9b ;
  background: linear-gradient(316deg, #780d9b 0%, #a594f9 74%);
}
::selection{
  color: #fff;
  background: #780d9b;
    ...
    <section class="post">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        <div class="content">
          ...
          <div class="details">
            <p><?php echo $_SESSION['ngo_user_name']; ?></p>
          </div>
        </div>
