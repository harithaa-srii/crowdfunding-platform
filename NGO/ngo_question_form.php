<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO ngo_queries (nch_id, nch_user_id, nch_user_name, nch_user_phone, nch_user_email, nch_desc, nch_date) VALUES (:postID, :user_id, :username, :phoneNumber,:email, :description, :date)");
            ...
            <div class="column">
                ...
                <form method="POST" action="ngo_question_form.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username" value="<?php echo isset($_SESSION['ngo_username']) ? $_SESSION['ngo_username'] : ''; ?>" required>
                    </div>
                    <div class="form-group">
