...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($accReqStatus == 'Pending' || $accReqStatus == 'Rejected') {
            ...
            $_SESSION['ngo_user_name'] = $username;
            $_SESSION['ngo_user_email'] = $email;
            $_SESSION['ngo_user_phone'] = $userphone;
            $_SESSION['ngo_org_name'] = $organization;
            $_SESSION['ngo_org_mail'] = $organizationemail;
            $_SESSION['ngo_org_place'] = $location;
...
<head>
    ...
    <style>
        body{
            ...
            background-image: url("ngo-login-img.jpg");
    ...
    <div class="container">
        ...
        <h3>NGO Login</h3>
            <div class="posi">
                ...
                <br>
                <a href="ngo_forgot_pwd.php">Forgot Password?</a>
