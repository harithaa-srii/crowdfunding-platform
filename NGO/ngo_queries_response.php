...
try {
    ...
    $query = "SELECT * FROM ngo_queries WHERE nch_user_id = :ngo_id ORDER BY nch_date DESC";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['delete_post'])) {
            ...
            $query = "DELETE FROM ngo_queries WHERE nch_id = :nch_id";
            $stmt = $conn->prepare($query);
            $stmt->bindParam(':nch_id', $post_id);
            $stmt->execute();
    ...
    <head>
        <title>NGO Questions Manage</title>
                ...
                <?php if (!empty($posts)) : ?>
                    <?php foreach ($posts as $post) : ?>
                        <li class="post-item">
                            <div class="post-info">
                                <div class="tags">
                                    <span class="tag username-tag"><?php echo $post['nch_user_name']; ?></span>
                                    <span class="tag phone-tag"><?php echo $post['nch_user_phone']; ?></span>
                                    <span class="tag date-tag"><?php echo $post['nch_date']; ?></span>
                                </div>
                                <div class="public-q-description">
                                    <p class="ur-q">Your Question:</p>
                                    <p class="pch-desc"> <?php echo $post['nch_desc']; ?></p>
                                </div>
                                <div class="admin-ans-description">
                                    <p class="ur-ans">Admin Answer:</p>
                                    <p class="pch-admin-reply"><?php echo $post['nch_admin_reply']; ?></p>
                                </div>
                            </div>
                            <div class="post-actions">
                                <form method="post" onsubmit="return confirm('Are you sure you want to delete this Question?')">
                                    <button type="submit" name="delete_post" value="<?php echo $post['nch_id']; ?>">Delete</button>
                                </form>
                            </div>
                        </li>
                    <?php endforeach; ?>
